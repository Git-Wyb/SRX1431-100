...
UINT32 PROFILE_CH_FREQ_32bit_200002EC = 426075000ul;
const UINT32 PROFILE_CH1_FREQ_32bit_429HighSpeed=429350000;//429350000;//429225000;
const UINT32 PROFILE_CH2_FREQ_32bit_429HighSpeed=429550000;
UINT8 Channels = 1;
UINT32 ID_SCX1801_DATA = 1;
UINT8 Flag_TX_ID_load = 0;
